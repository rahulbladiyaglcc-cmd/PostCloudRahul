    ...
    <v-card-text>
      <div class="d-flex align-start mb-6">
        <v-btn icon rounded="sm" color="darksecondary" variant="flat">
          ...
          <FileBarcodeIcon stroke-width="1.5" width="20" />
        </v-btn>
      ...
      <h2 class="text-h1 font-weight-medium">
        500 <a href="#"><CircleArrowUpRightIcon stroke-width="1.5" width="28" class="text-white" /> </a>
      </h2>
      <span class="text-subtitle-1 text-medium-emphasis text-white">New Entries</span>
    </v-card-text>
  </v-card>
</template>
