    ...
    <v-card-text class="pa-5">
      <div class="d-flex align-center ga-4">
        ...
        <div>
          ...
          <span class="text-subtitle-2 text-medium-emphasis text-white">Total Regions</span>
        </div>
      </div>
    </v-card-text>
  </v-card>
  ...
  <v-card elevation="0" class="bubble-shape-sm overflow-hidden bubble-warning">
    <v-card-text class="pa-5">
      <div class="d-flex align-center ga-4">
        ...
        <div>
          <h4 class="text-h4 font-weight-medium">203k</h4>
          <span class="text-subtitle-2 text-disabled font-weight-medium">Total Panchayath</span>
        </div>
      </div>
    </v-card-text>
  </v-card>
